...
new Vue({
    ...
    mounted() {
        if (route().current("home")) {
            ...
            setTimeout(() => {
                this.setAllCategoriesMenuHeight();
                this.setAllCategoriesMenuItem();
            }, 0);
    ...
    methods: {
        setAllCategoriesMenuHeight() {
            $(".category-dropdown").css(
                "height",
                `${$(".home-slider").height() - 2}px`
            );
        },

        setAllCategoriesMenuItem() {
            let verticalMegaMenuListHeight = 0,
                categoryDropdownHeight = $(".home-slider").height();
